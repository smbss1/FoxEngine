...
ed::Transaction ed::EditorContext::MakeTransaction(const char* name)
{
    ...
    if (m_Config.Transaction.Constructor)
        transactionInterface = m_Config.Transaction.Constructor(name, m_Config.Transaction.UserPointer);
...
{
    if (m_Config.Transaction.Destructor)
        m_Config.Transaction.Destructor(transaction, m_Config.Transaction.UserPointer);
}
