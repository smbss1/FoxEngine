...
namespace Fox
{
	...
	public struct Color : IEquatable<Color>
	{
		...
		// Static Methods
		[MethodImpl(INLINE)]
		public static implicit operator Vector4(in Color color) { return new Color(color.r, color.g, color.b, color.a); }
		[MethodImpl(INLINE)]
		public static implicit operator Vector3(in Color color) { return new Color(color.r, color.g, color.b); }
