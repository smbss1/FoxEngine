...
//        s_Data->EntityClass = ScriptClass("Hazel", "Entity", true);
    ...
    void ScriptEngine::InitMono()
    {
        ...
        s_Data->CoreAssembly = LoadCSharpAssembly("Resources/Scripts/Fox-ScriptCore.dll");
        Utils::PrintAssemblyTypes(s_Data->CoreAssembly);

        MonoImage* assemblyImage = mono_assembly_get_image(s_Data->CoreAssembly);
        MonoClass* monoClass = mono_class_from_name(assemblyImage, "Fox", "Main");
...
//        instance->InvokeOnUpdate(Time::delta_time);
//    }
//
