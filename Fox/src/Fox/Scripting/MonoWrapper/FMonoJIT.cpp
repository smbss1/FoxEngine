...
#include "FMonoJIT.hpp"
#include "FMonoLogger.hpp"
...
namespace fox::mono
{
    ...
    bool FMonoJIT::Init(const std::string& domain, bool enable_debugging)
    {
    ...
    void FMonoJIT::SetAssembliesPath(const fs::path& path)
    {
    ...
    std::string FMonoJIT::CreateCompileCommand(const compiler_params& params)
    {
        // TODO: Use mono compiler instead of mcs
    ...
    bool FMonoJIT::Compile(const compiler_params& params)
    {
        auto command = CreateCompileCommand(params);
