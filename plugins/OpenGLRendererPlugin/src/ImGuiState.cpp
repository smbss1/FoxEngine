...
namespace fox
{
    ImGuiState::ImGuiState() : State("ImGui State")
    {
    }

    void ImGuiState::OnEnter()
    {
        ...
        auto* window = static_cast<GLFWwindow*>(GetApp().GetWindow()->GetNativeWindow());
    ...
    void ImGuiState::OnEvent(Event &event)
    {
        if (m_bBlockEvents)
        {
    ...
    void ImGuiState::SetDarkThemeColors()
    {
